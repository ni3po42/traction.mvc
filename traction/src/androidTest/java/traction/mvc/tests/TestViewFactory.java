...
public class TestViewFactory extends InstrumentationTestCase
{
    ...
    public void testCanIgnoreChildren()
    {
        ...
        when(parentLayout.getTag(R.id.viewholder)).thenReturn(parentVB);
        ...
        //assert
        assertNotNull(v);
        verify(v, never()).setTag(eq(R.id.viewholder), any(IViewBinding.class));
    }
    ...
    public void testChildrenIgnoredWhenParentHasNoViewHolderAndRootFalse()
    {
        ...
        when(parentLayout.getTag(R.id.viewholder)).thenReturn(null);
