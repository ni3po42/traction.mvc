...
public class DemoADialogController extends FragmentController
{
	@Override
	public void onCreate(Bundle savedInstanceState) 
	{
		super.onCreate(savedInstanceState);
        View.setContentView(R.layout.dialoglauncher);
	};
    ...
    public void onStart()
    {
        ...
        model.getOpen().setExecuteListener(new IOnExecuteListener() {
            ...
            public void onExecuted(CommandArgument argument) {
                ActualDialogController dialog = new ActualDialogController();
